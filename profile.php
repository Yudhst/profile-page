<html>
    ...
    <body>
        <br>
        <div>
            <table class="tabel" id="tbl" style="display:none;">
                <tr>
                    <td width="30%" align="center">
                        <img src="assets/img/CV-Pict.png" alt="pp" class="profile-pict">
                        <h3 style="font-family: 'Dancing Script', cursive; font-size: 30px;">Naufal Yudhistira</h3>
                        <span>
                            <i class="fas fa-map-marker-alt    "></i>
                            <span>Malang, Indonesia</span>
                        </span>
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Non impedit laudantium corrupti,
                            delectus quod sint mollitia quidem voluptates assumenda sed voluptatem. Tenetur, sequi nihil
                            aut consequuntur numquam iusto commodi aliquam assumenda, reprehenderit recusandae excepturi
                            atque!
                        </p>
                        <br>
                    </td>
                    <td>
                        ...
                        <ul>
                            ...
                            <li>Participant of National Skills Competition in IT Software Solution for Business</li>
                        </ul>
                        <br>
                        <h3>
                        ...
                        <p>
                            ...
                            <a href="https://github.com/Yudhst/" target="_blank"><img src="assets/img/git-hover.png"
                                    class="sosmed-icon"></a>
                        </p>
                    </td>
                </tr>
